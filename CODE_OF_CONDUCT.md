...
We as members, contributors, and leaders pledge to make participation in the **Primary / Humming Box Problem** repository a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community — one where **meaning, context, and interpretation** are respected as much as the bits we preserve.

## Our Standards

Examples of behavior that contributes to a positive environment:

- **Respect the problem, not just the data** — Engage with the philosophical and technical challenges of digital continuity.
- **Assume good faith** — Disagreements about preservation, identity, and drift are expected; debate the idea, not the person.
- **Be curious, not combative** — The Humming Box Problem asks hard questions; answers are provisional, not final.
- **Use welcoming language** — Not everyone has a computer science or archival background.
- **Show empathy** — Digital loss affects researchers, archivists, artists, and communities differently.

Examples of unacceptable behavior:

- Harassment, trolling, or insulting comments
- Publishing others' private information without permission
- Dismissing lived experience or domain expertise
- Claiming authority without evidence (e.g., "you just don't get it")
- Disrupting good-faith discussion about meaning drift, lineage, or provenance
...
This Code of Conduct applies within all community spaces (Issues, Discussions, pull requests, commits) and also applies when an individual is officially representing the community in public spaces (e.g., citing this repository or its ideas).
